...
The preliminary outputs below compare the PCIC gridded model outputs for the historic period of 1971-2000 to the future period of 2041-2070.  For each CU and time period, the average indicator value for grid cells within the CU boundary is calculated and plotted. 

PCIC indicators for flow and temperature are summarized.
