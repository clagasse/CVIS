...
For each CU and indicator, the plots show the ensemble mean value for all accessible streams that are modelled as potential spawning or rearing habitat. 

Stream accessibility is based upon the [BC Fishpass accessibility model] (https://smnorris.github.io/bcfishpass/02_model_access.html) that evaluates the existence of downstream barriers.  Stream habitat suitability  is based on the [BC Fishpass linear spawning/rearing habitat model] (https://smnorris.github.io/bcfishpass/03_model_habitat_linear.html) that considers species specific criteria for gradient, channel width or discharge, and network connectivity.   
